                      ...
                      <td colSpan={7} className="p-4">
                        <div className="rounded-2xl border border-slate-200 bg-slate-50/60 p-4">
                          ...
                          <div className="grid gap-2 sm:grid-cols-2">
                            ...
                            <label className="relative sm:col-span-2"><FiTag className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-blue-700" /><input className={`${inputClassName} w-full pl-9`} placeholder="Category" value={form.category} onChange={(e) => setField("category", e.target.value)} disabled={!isPending || isMutating} /></label>
