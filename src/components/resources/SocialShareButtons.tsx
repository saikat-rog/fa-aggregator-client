  ...
  return (
    <div className={`relative inline-flex items-center gap-2 ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-2.5 text-xs font-bold text-white shadow-xs transition hover:bg-slate-800 cursor-pointer active:scale-95"
      >
      ...
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-full border px-4.5 py-2.5 text-xs font-bold transition shadow-xs cursor-pointer active:scale-95 ${
          copied
